...
Pod::Spec.new do |s|
  s.name             = 'NewsApiSwift'
  s.version          = '0.1.0'
  s.summary          = 'A short description of NewsApiSwift.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Blazej SLEBODA/NewsApiSwift'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Blazej SLEBODA' => 'contact@blazejsleboda.fr' }
  s.source           = { :git => 'https://github.com/Blazej SLEBODA/NewsApiSwift.git', :tag => s.version.to_s }
